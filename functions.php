...
if ( ! function_exists( 'gh_exam_setup' ) ) :
	...
	function gh_exam_setup() {
		...
		register_nav_menus( array(
			'header-menu' => esc_html__( 'Header Menu', 'gh-exam' ),
		) );
...
{
    register_post_type('hero-slider',
        array(
            'labels' => array(
                'name' => __('Hero Slider'),
...
function gh_exam_scripts() {
    ...
    wp_enqueue_style( 'gh-exam-reset-style', get_template_directory_uri() . '/dist/css/reset.css' );

    wp_enqueue_style( 'gh-exam-main-style', get_template_directory_uri() . '/dist/css/main.min.css' );

    wp_enqueue_style('google-fonts', 'https://fonts.googleapis.com/css?family=Nunito:400,700,800|Poppins:400,700');

    wp_enqueue_style('font-awesome', 'https://use.fontawesome.com/releases/v5.8.1/css/all.css');

    wp_enqueue_script( 'gh-exam-scripts', get_template_directory_uri() . '/dist/js/index.min.js', array(), '', true );
